...
namespace Курсовая
{
    class Medicine
    {
        ...
        public static void FilterByType(List<Medicine> medicines)
        {
            Console.Write("Введите категорию препарата: ");
            string type = Console.ReadLine();
            bool found = false;
            ...
            if (!found)
                Console.WriteLine("Препаратов данной категории не найдено.");
